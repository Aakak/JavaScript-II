...
runners.forEach(function(items) {
  return fullNames.push(`${items.first_name}
  ${items.last_name}`);
});
...
// Problem 1
let addRunners = runners.splice(function(newRunner){
 return newRunner.first_name = "Akak";
});

console.log(addRunners);


// Problem 2
let lastIndex = runners.lastIndexOf(function(runners){
  return runners.;
 });
