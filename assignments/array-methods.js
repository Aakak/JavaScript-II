...
// Problem 1
let runEmailList5k = runners.map(function(item) {
  return item.email;
});

console.log(runEmailList5k);

// Problem 2
let runSponsorList5k = [];
runners.forEach(function(item) {
  runSponsorList5k.push(item.company_name);
});

console.table(runSponsorList5k);
// Problem 3

let smallShirts = runners.filter(function(item) {
